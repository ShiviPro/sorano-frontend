...
export const allEvents = [
  {
    ...
    description: `<p>Join up to 100 artists for a full day of drawing from multiple live models. Starting at 10:00 am on Sunday, April 6th, artists can work in three distinct categories:</p>      
    <ul>
      <li>Long Pose Figure Drawing (6-hour pose)</li>
      <li>Short Pose Figure Drawing (changes every hour)</li>
      <li>Portrait Drawing (6-hour pose)</li>
    </ul>

    <p>A note about the word “competition”: We believe that drawing with others of various skill levels drives us to work at our highest abilities. This competition is designed to foster camaraderie and inspiration within the community. Artists are not required to submit their work for judging.</p>

    <ol>
    <li>Morning Drawing Session 10:00 am – 1:00 pm.</li>
    <li>Lunch (not provided) 1:00 – 2:00 pm.</li>
    <li>Afternoon Drawing Session 2:00 – 5:00 pm.</li>
    <li>Judging 5:00 pm.</li>
    <li>Winners Announced 5:30 pm.</li>
    </ol>

    <p>Artists may work in dry media only, including graphite, charcoal, and pastel pencils. Loose, dry pastels are not permitted for health reasons. Artists may work up to 18″x24″. We do not accept digital art for submission for judging.</p>

    <p>Entry to the space begins at 9:45 am in order of arrival. Seating is strictly first come, first served, and seats may not be saved for artists who are not present. Each artist will be given two chairs to work with, allowing them to place their board on the back of one chain and sit on the other. Compact easels are permitted on a case-by-case basis (space permitting). Easels may not occupy the front row of any model area.</p>`,
